/**
 * The goal of this problem is to implement the "Median Maintenance" algorithm (covered in the Week 3 lecture on heap applications). Determine the last 4 digits of the sum of all the medians of the given stream of input numbers.
 * 
