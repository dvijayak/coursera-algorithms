/**
 * Array-based implementation of the _heap_ data structure.
 * 
 * We will verify correctness by performing heapsort, an algorithm that requires heap insertion as well as the ExtractMin operation.
 */
